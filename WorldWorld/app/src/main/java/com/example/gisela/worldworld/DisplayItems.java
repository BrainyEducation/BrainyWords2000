...
public class DisplayItems extends AppCompatActivity implements MyAdapter.ClickListener{
    ...
    private List<Item> allBackgroundImages;
    ...
    public List<Item> getData()
    {
        ...
        allBackgroundImages = new ArrayList<>();
        Drawable image;
        ...
        try
        {
            ...
            for(int i = 0; i < path.length; i++)
            {
                ...
                allBackgroundImages.add(current);
        ...
        // Only load the first three background images to start with
        // The rest are loaded dynamically as the user scrolls
        for(int i = 0; i < 3; i++){
            data.add(allBackgroundImages.get(i));
        }
        return  data;
